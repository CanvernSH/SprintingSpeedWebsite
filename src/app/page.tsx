      ...
      <div id="home" className="pt-20">
        ...
        <section id="about" className="py-20 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">About Your Coach</h2>
            <p className="text-lg text-gray-700">
              With years of experience coaching athletes at all levels, I focus on building tailored programs
              that improve performance, reduce injury risk, and boost confidence.
            </p>
          </div>
        </section>
